...
- ANTI-TRONCATURE & AGENCEMENT : le texte ne doit JAMAIS être coupé ou tronqué. Chaque bloc de texte doit être entièrement visible. Utilise word-wrap: break-word et overflow-wrap: break-word sur les conteneurs texte. N'utilise JAMAIS overflow: hidden sur un bloc contenant du texte narratif. Si un texte risque de déborder, reformule-le plus court ou redistribue l'espace entre les blocs voisins. Agence intelligemment les blocs pour occuper tout l'espace disponible : si un bloc a peu de contenu et un autre en a beaucoup, rééquilibre les tailles pour éviter à la fois les vides et les débordements. L'espace de la page doit être exploité de manière homogène.
